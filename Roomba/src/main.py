...
def initialize_objects():
    ...
    RangefinderSensor = Analog(RANGEFINDER_PORT)
    
    sensors = {RANGEFINDER: RangefinderSensor}
...
def main3():
    ...
    #driver.drive_distance(100, -250)
    
    #driver.drive_distance(50, -450)
    #return

    #driver.turn(-360, 250, accel=False)

    # Need to test drive_straight vs drive_x and drive_y
    
    driver.turn(-90, 250)
    driver.drive_distance_x(100, -450)
    driver.turn(90, 250)
    driver.drive_distance_y(100, 450)
    driver.turn(-360, 250)
    driver.drive_distance_y(100, -450)
    driver.turn(90, 250)
    driver.drive_distance_x(100, 450)
    ...
    driver.turn(-45, 250)
    driver.drive_distance(100, -450)
    driver.turn(45, 250)
    driver.drive_distance_x(100, 450)
        
    driver.turn(-90, 250)
    driver.drive_distance_y(100, 450)
    # Test same thing with turning 90 degrees
